...
<fr:form action="/enterprise.do?method=createEnterprise" encoding="multipart/form-data"> 
	...
	<fr:edit id="enterpriseBean" name="enterpriseBean" >
		<fr:schema bundle="JOB_BANK_RESOURCES" type="module.jobBank.domain.beans.EnterpriseBean">
			<fr:slot name="password" key="label.enterprise.password" required="true" layout="password"/>
			<fr:slot name="repeatPassword" key="label.enterprise.repeatPassword" required="true" layout="password"/>
		</fr:schema>
	...
	<fr:edit id="enterpriseBean2" name="enterpriseBean" >
		...
		<fr:slot name="summary" key="label.enterprise.summary"  layout="area" required="true">  
