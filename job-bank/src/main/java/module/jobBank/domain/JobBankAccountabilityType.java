...
public enum JobBankAccountabilityType implements IPresentableEnum {
	...
	PENDING("Pending", "label.jobBank.pending"), JOB_PROVIDER("JobProvider", "label.jobBank.jobProvider"),
	JOB_PROVIDER_WITH_PRIVILEGES("jobProviderWithPrivileges", "label.jobBank.jobProviderWithPrivileges");
	...
	public void createAccountabilityType() {
		final AccountabilityTypeBean accountabilityTypeBean =
				new AccountabilityTypeBean(getType(), new MultiLanguageString(getLocalizedName()));
