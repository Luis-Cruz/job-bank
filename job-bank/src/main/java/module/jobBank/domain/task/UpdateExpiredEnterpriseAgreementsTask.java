...
public class UpdateExpiredEnterpriseAgreementsTask extends UpdateExpiredEnterpriseAgreementsTask_Base {
	...
	String emailSubject = getMessageFromBundle("message.jobbank.message.jobbank.email.warning.expired.agreement.subject",
		String.valueOf(monthsToExpire));
	StringBuilder body = new StringBuilder();
	String message = getMessageFromBundle("message.jobbank.enterprise.warning.expired.agreement.email.body", enterprise
		.getName().toString(), enterprise.getActiveAccountabilityType().getName().toString(),
		String.valueOf(monthsToExpire));
	body.append(message);
