...
<fr:form action='<%="/workflowProcessManagement.do?method=process&activity="+activityName+"&processId="+processOID %>'>
	<fr:edit name="information" id="activityBean"> 
		<fr:schema  type="module.jobBank.domain.activity.JobOfferInformation"  bundle="JOB_BANK_RESOURCES">	    
			...
			<fr:slot name="jobOfferBean.function" key="label.enterprise.jobOffer.function"/>
			...
			<fr:slot name="jobOfferBean.descriptionOffer" key="label.enterprise.jobOffer.descriptionOffer" layout="longText">  
				<fr:property name="columns" value="60" />
				<fr:property name="rows" value="6" />
			</fr:slot>
			<fr:slot name="jobOfferBean.requirements" key="label.enterprise.jobOffer.requirements" layout="longText">  
				<fr:property name="columns" value="60" />
				<fr:property name="rows" value="6" />
			</fr:slot>
