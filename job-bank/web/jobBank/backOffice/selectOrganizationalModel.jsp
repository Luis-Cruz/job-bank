...
<h2><bean:message key="label.configuration.select.organizationalModel" bundle="JOB_BANK_RESOURCES"/></h2>
...
<logic:notEmpty name="organizationalModels">
	<chart:orgChart id="organizationalModel" name="organizationalModelChart" type="java.lang.Object">
		<div class="orgTBox orgTBoxLight">
				...
				<html:link action="/backOffice.do?method=selectOrganizationalModel" paramId="organizationalModelOid" paramName="organizationalModel" paramProperty="externalId">
